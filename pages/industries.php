...
$metaDesc = 'JAGS Technologies provides NDT and automation solutions across automotive, aerospace, oil & gas, power plants, railways, foundries, forging and fabrication industries.';
...
<section class="section">
    <div class="container">
        <div class="industry-grid grid-three">
            <?php
            ...
            <div class="industry-card" data-cursor="EXPLORE" style="aspect-ratio: 16/10;">
                <div class="industry-card-placeholder" style="padding: 0;">
                    <img src="<?= image_uri($ind['image'], placeholder_img()) ?>" alt="<?= e($ind['name']) ?>" loading="lazy" decoding="async" style="width: 100%; height: 100%; object-fit: cover;">
                </div>
